...
None — all required PRD elements (vision, persona, success criteria, user stories, FRs, NFRs, business logic, access control, non-goals) were captured during shaping, and the closing quality cross-check in shape-notes.md recorded no gaps.
